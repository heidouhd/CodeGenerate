...
<head>
    ...
    <title>添加${table.remark}</title>
    <meta name="description" content="添加${table.remark}">
        ...
        <div>
            ...
            <div class="layui-form-item" style="text-indent: 0;margin: 0">
                <label for="inputEmail3" class="layui-form-label">
                    <button class="layui-btn" type="button" onclick="doSave()"
...
<script type="text/javascript" src="add${table.name?substring(2)?cap_first}.js"></script>
</html>
